...
function btn_checkout_handler() {
    ...
    if (contactPhone == "")
    {
        document.getElementById('error_phone').innerHTML = 'This is required';
...
function valid_month() {
    ...
    if (month == '') {
        ...
        document.getElementById('cred_exp_month').innerHTML = 'Enter valid month';
...
function valid_year() {
    ...
    if (year == '') {
        document.getElementById('cred_exp_year').innerHTML = 'Enter only 2 last digit year';
        document.getElementById('year').focus();
    }
    else if (year.length != 2) {
        document.getElementById('cred_exp_year').innerHTML = 'Enter valid only 2 digit year';
        document.getElementById('year').focus();
    }
    else
...
function valid_credit_card_number() {
    ...
    if (num == '') {
        ...
        document.getElementById('valid_cred_card_num').innerHTML = 'Card Number is required';
